...
class KafkaBridgeClosed(Exception):
    """Error signaling that KafkaBridge is closed."""
...
class KafkaBridge:
    """KafkaBridge holding client_message and server_message.
